...
export class CodeSettingTab extends PluginSettingTab {
  ...
  private renderLanguages(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc("Absolute path to a Python 3.13 interpreter with MATLAB Engine installed. MATLAB sessions are per note; clear the note session after changing this path.")
      .addText((t) => {
