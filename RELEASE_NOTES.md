...
- **Configurable code block passthrough languages** — add one fenced-code language per line under Settings → CodeSuite → Languages to let Obsidian or another plugin render those blocks in Live Preview and reading view ([#46](https://github.com/felixleopold/obsidian-code-suite/issues/46)).
